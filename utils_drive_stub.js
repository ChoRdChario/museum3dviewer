// NOTE: This is a stub for pre-push demo. Replace with real drive.js wired to gapi.
...
export async function fetchDriveFileAsArrayBuffer(id){
  // If authenticated and using gapi, you can implement real download here.
  // For pre-push, allow demo via public sample GLB if 'demo' keyword is used.
  if (id === 'demo') {
  ...
  // Fallback: try direct "uc?export=download&id=" pattern (works when file is public)
