...
// NOTE: This file is self-contained toward app glue. Three.js-side lives in viewer.module.cdn.js
...
setupAuth($('auth-signin'), signedSwitch);
...
// ---------- caption overlay (draggable & anchored) ----------
...
function appendCaptionItem({id,title,body,color,imageUrl}){
  ...
  div.innerHTML = `${imageUrl?`<img src="${imageUrl}" alt="">`:''}
    <div class="cap-txt">
  ...
  div.addEventListener('click', (e)=>{
    if (e.target.closest('.c-del')) return; // delete handled below
