...
/* glb.btn.bridge.share.js — v3.4 (loader + save sheet ensure + gid-first ctx)
 * viewer.module.cdn.js の export から __lm_viewer_bridge を組み立てる（案1ベース）
 */
(function(){
  const TAG='[glb-bridge-share]';
  ...
  async function postLoadEnsureSaveSheet(_fileId){ /* share: no-op (no create/ensure) */ }
