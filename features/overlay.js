export function mountOverlay({ bus, store }){
  ...
  function show(c){ t.textContent=c.title||''; b.textContent=c.body||''; if(c.img){ i.src=c.img; i.style.display='block'; } else { i.style.display='none'; } el.style.display='block'; }
